...
if [ "$PROJ" == "cuda" ] || [ "$EXT" == "-gpu" ]; then
       ...
       curl -L -o cudnn-9.2-windows7-x64-v7.2.1.38.zip "https://developer.download.nvidia.com/compute/redist/cudnn/v7.2.1/cudnn-9.2-windows7-x64-v7.2.1.38.zip"
       ./cuda_9.2.88_windows.exe -s
       sleep 60
       ./cuda_9.2.88.1_windows.exe -s
       sleep 10
       unzip ./cudnn-9.2-windows7-x64-v7.2.1.38.zip
